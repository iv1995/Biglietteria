This application allows you to buy tickets 

Before executing it you have to create a database name 'app' and fill all the tables (the database data is available in the Database directory).
